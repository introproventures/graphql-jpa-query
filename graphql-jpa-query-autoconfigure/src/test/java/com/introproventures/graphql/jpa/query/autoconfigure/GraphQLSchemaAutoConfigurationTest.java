...
public class GraphQLSchemaAutoConfigurationTest {
    ...
    static class Application {
        ...
        /**
         * GraphQLSchemaFactoryBean maps all fields of the object "Mutation" to a new GraphQLObjectType
         */
        @Component
        static class MutationGraphQLSchemaConfigurer implements GraphQLSchemaConfigurer {
            ...
            public void configure(GraphQLShemaRegistration registry) {
                ...
                GraphQLCodeRegistry codeRegistry = newCodeRegistry()
                    .dataFetcher(
                        coordinates("Mutation", "greet"),
                        (DataFetcher<String>) environment -> "hello world"
                    ).build();
        ...
        /**
         * GraphQLSchemaFactoryBean maps all fields of the object "Query" to a new GraphQLObjectType with the from GraphQLJpaQueryProperties
         */
        @Component
        static class QueryGraphQLSchemaConfigurer implements GraphQLSchemaConfigurer {
            ...
            public void configure(GraphQLShemaRegistration registry) {
                ...
                GraphQLCodeRegistry codeRegistry = newCodeRegistry()
                    .dataFetcher(coordinates("GraphQLBooks", "hello"), (DataFetcher<String>) environment -> "world")
                    .build();

                registry.setCustomDataFetcher(codeRegistry);
            }
        }
    }
